...
class App(QtWidgets.QMainWindow, foton_display3.Ui_MainWindow):
    ...
    def get_daily_power(self, month, day):
        ...
        ax = fig.add_subplot()
        ax.set_title('Самый благоприятный день по приходу солнечной энергии' + str(day) + ' число ' + str(month) + ' мес', fontsize = 8)
        ax.set_xlabel('Время суток, ч', fontsize=8)
    ...
    def get_daily_workload(self, month, day):
        ...
        fig = Figure(figsize=(5,1.5))
        ax = fig.add_subplot()
        ax.set_title('Нагрузка ' + str(day) + ' число ' + str(month) + ' мес', fontsize = 8)
        ax.set_xlabel('Время суток, ч', fontsize=8)
    ...
    def get_year_dE(self):
        ...
        fig = Figure(figsize=(5,1.5))
        ax = fig.add_subplot()
        ax.set_title('Избыток/Недостаток суточной энергии', fontsize = 8)
